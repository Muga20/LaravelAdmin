            ...
            <div class="content-wrapper">
                <div class="row">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Update Products Form </h4>
                                ...
                                <form class="forms-sample" action="{{ route('updateProducts' ,$product->id) }}" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group col-xs-12">
                                            <input type="file" class="form-control file-upload-info" name="image"
                                                id="exampleFormControlFile1" value="{{ $product->image }}">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleTextarea1">Write Your Updated Description Here</label>
                                        <textarea class="form-control " name="description" id="exampleTextarea1" rows="4" value="{{ $product->body }}"></textarea>
